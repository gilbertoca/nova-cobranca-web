...
public class BopepoEmissorBoletoBradesco implements EmissorBoleto {

	private static final long serialVersionUID = 1L;
	
	private GeradorDigitoVerificadorBradesco geradorDigitoVerificador;
	
	@Inject
	public BopepoEmissorBoletoBradesco(GeradorDigitoVerificadorBradesco geradorDigitoVerificador) {
